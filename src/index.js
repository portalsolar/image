 ...
 * @property {boolean} leftImage - should image be rendered align left
 * @property {boolean} rightImage - should image be rendered align right
 * @property {boolean} centerImage - should image be rendered align center
